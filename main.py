...
if __name__ == "__main__":
    try:
        ...
        choices = ["Offline global aligment (Needleman-Wunsch)", "Various online aligments (EMBOSS)"]
        ...
        if choice == choices[0]:
            ...
            if gap_choice == gap_choices[0]:
                ...
                result1, result2 = offline_needleman.needleman_wunsch_linear(fieldValues[0], fieldValues[1], traceback, int(fieldValues[2]), int(fieldValues[3]), int(fieldValues[4]))
            elif gap_choice == gap_choices[1]:
                fieldValues[0] = ''.join(e for e in fieldValues[0] if e.isalnum())
                fieldValues[1] = ''.join(e for e in fieldValues[1] if e.isalnum())
            ...
            choices = ["Smith-Waterman","Needleman-Wunsch","Needleman-Wunsch (Stretcher Modification)","Matcher (LALIGN based)"]
            choice = easygui.choicebox(msg, title, choices)
